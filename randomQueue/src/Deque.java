...
public class Deque<Item> implements Iterable<Item> {
    ...
    public void addLast(Item item)           // insert the item at the end
    {
        ...
        if (oldlast != null)
            oldlast.next = last; //ha! but not very sure... Seems that I can't implement removeLast for multiple calls.
        else first = last;
        N++;
    }
    ...
    public Item removeFirst()                // delete and return the item at the front
    {
        ...
        N--;
        if(N==0) last=null; //in case when there's only 1 element remaining and got removed... avoid loitering! (shareptr)
        return firstItem;
    }
